      ...
      <div className="grid grid-cols-2 md:grid-cols-3 text-gray-500">
        {
            languages.map(lang=>(
                ...
                <div className={`${lang.isDefault ? "hidden" : ""} bg-gray-50 m-4 p-4 rounded-xl text-center hover:text-primary-500 hover:bg-primary-50 hover:font-semibold shadow cursor-pointer dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800`}>
